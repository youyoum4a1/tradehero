...
public class New_user_Activity extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.btn_linkedin:
			...
			break;
		case R.id.txt_email:
			startActivity(new Intent(New_user_Activity.this,Registration_User_Activity.class));
