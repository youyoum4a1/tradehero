...
{
    public static final String TAG = WatchlistOpenIntentTest.class.getSimpleName();
    ...
    {
        assertEquals(PositionWatchlistFragment.class, new WatchlistOpenIntent(new PortfolioId(567)).getActionFragment());
    }
