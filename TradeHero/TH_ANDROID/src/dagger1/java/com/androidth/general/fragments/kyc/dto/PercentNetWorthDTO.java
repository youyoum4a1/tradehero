...
public class PercentNetWorthDTO
{
    ...
    @NonNull public static List<PercentNetWorthDTO> createList(@NonNull Resources resources, @NonNull List<PercentNetWorthForInvestmentRange> netWorthForInvestmentRanges)
    {
