...
public class Constants
{
    ...
    public static final String URL_TWITTER_OAUTH_TOKEN =
    ...
    public static final String CHECK_NAME_URL =
            BASE_API_URL + "api/checkDisplayNameAvailable?displayName=";
    //header
    public static final String CONTENT_TYPE = "Content-type";
    public static final String CONTENT_TYPE_VALUE_URL_ENCODED =
    ...
    public static final String PORTFOLIO_ROI_SINCE_INCEPTION_ANNUALIZED =
            "roiSinceInceptionAnnualized";
