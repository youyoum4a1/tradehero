...
public class RequestFactory
{
    ...
    public Request getRegistrationThroughEmailRequest(Context pContext, String pEmail,
            String pDisplayName, String pFirstName, String pLastName, String pPassword,
            String pConfirmPassword) throws JSONException
    {
        Request lRegistrationRequest = new Request();
        lRegistrationRequest.setApiUrl(Constants.SIGN_UP_WITH_EMAIL_URL);

        lRegistrationRequest.setParameter(
                new BasicNameValuePair(Constants.PASSWORD_CONFIRMATION, pConfirmPassword));
        lRegistrationRequest.setParameter(new BasicNameValuePair(Constants.PASSWORD, pPassword));
        lRegistrationRequest.setParameter(
                new BasicNameValuePair(Constants.DISPLAY_NAME, pDisplayName));
        ...
        lRegistrationRequest.setParameter(new BasicNameValuePair(Constants.TH_CLIENT_VERSION,
                Constants.TH_CLIENT_VERSION_VALUE));
    ...
    public Request getLoginThroughEmail(Context pContext, String pUserName, String pPassword)
    ...
    public Request getRegistrationThroughFB(String pFacebookAccessToken) throws JSONException
    {
        ...
        lRegistrationRequest.setParameter(
                new BasicNameValuePair(Constants.FB_ACCESS_TOKEN, pFacebookAccessToken));
        ...
        lRegistrationRequest.addRequestHeader(
                new BasicHeader(Constants.CONTENT_TYPE, Constants.CONTENT_TYPE_VALUE_URL_ENCODED));
        lRegistrationRequest.addRequestHeader(
                new BasicHeader(Constants.TH_CLIENT_VERSION, Constants.TH_CLIENT_VERSION_VALUE));
    ...
    public Request getRegistrationThroughLinkedIn(Context pContext,
            String pLinkedinAccessTokenSecret, String pLinkedinAccessToken) throws JSONException
    {
        Request lRegistrationRequest = new Request();
        lRegistrationRequest.setApiUrl(Constants.SIGN_UP_WITH_SOCIAL_MEDIA_USER_URL);
        lRegistrationRequest.setContext(pContext);
        ...
        lRegistrationRequest.setParameter(
                new BasicNameValuePair(Constants.LINKED_ACCESS_TOKEN_SCERET,
                        pLinkedinAccessTokenSecret));
        lRegistrationRequest.setParameter(
                new BasicNameValuePair(Constants.LINKED_ACCESS_TOKEN, pLinkedinAccessToken));
        ...
        System.out
                .println("variables--------------"
                        ...
                        + pLinkedinAccessTokenSecret
                        + " token-"
                        + pLinkedinAccessToken);
        return lRegistrationRequest;
    }

    public Request getRegistrationThroughTwitter(String pEmailId, String pTwitterAccessTokenSecret,
            String pTwitrerAccessToken) throws JSONException
    {
        Request lRegistrationRequest = new Request();
        lRegistrationRequest.setApiUrl(Constants.SIGN_UP_WITH_SOCIAL_MEDIA_USER_URL);
        lRegistrationRequest.addRequestHeader(new BasicHeader(Constants.TH_CLIENT_VERSION,
                Constants.TH_CLIENT_VERSION_VALUE_NEW));
        lRegistrationRequest.addRequestHeader(
                new BasicHeader(Constants.CONTENT_TYPE, Constants.CONTENT_TYPE_VALUE_URL_ENCODED));
        lRegistrationRequest.setParameter(new BasicNameValuePair("email", pEmailId));
        lRegistrationRequest.setParameter(
                new BasicNameValuePair(Constants.TWITTER_ACCESS_TOKEN, pTwitrerAccessToken));
        lRegistrationRequest.setParameter(
                new BasicNameValuePair(Constants.TWITTER_ACCESS_TOKEN_SCERET,
    ...
    public Request getLoginThroughFB(String pFBAuthToken) throws JSONException
    {
        ...
        lLoginRequest.setApiUrl(Constants.LOGIN_URL);
        lLoginRequest.setParameter(
                new BasicNameValuePair(Constants.CLIENT_VERSION, Constants.CLIENT_VERSION_VALUE));
        lLoginRequest.setParameter(
                new BasicNameValuePair(Constants.CLIENT_OS, Constants.CLIENT_OS_VALUE));
        lLoginRequest.addRequestHeader(
                new BasicHeader(Constants.TH_CLIENT_VERSION, Constants.TH_CLIENT_VERSION_VALUE));
        lLoginRequest.addRequestHeader(new BasicHeader(Constants.AUTHORIZATION,
                Constants.TH_FB_PREFIX + " " + pFBAuthToken));
    ...
    public Request getLoginThroughLinkedIn(Context pContext, String pLinkedinAccessTokenSecret,
            String pLinkedinAccessToken) throws JSONException
    {
        Request lLoginRequest = new Request();
        lLoginRequest.setApiUrl(Constants.LOGIN_URL);
        lLoginRequest.setParameter(
        ...
        lLoginRequest.addRequestHeader(
                new BasicHeader(Constants.CONTENT_TYPE, Constants.CONTENT_TYPE_VALUE_URL_ENCODED));
        lLoginRequest.setRequestType(
                Request.REQUEST_TYPE_POST);        //lLoginRequest.setRequestJSonObject(jsonLoginObject);
        _setToken(pContext, pLinkedinAccessToken, pLinkedinAccessTokenSecret);
        return lLoginRequest;
    }

    public Request getLoginThroughTwiiter(Context ctx, String pTwitterAccessTokenSecret,
            String pTwitrerAccessToken) throws JSONException
    {
        Request lLoginRequest = new Request();
        lLoginRequest.setApiUrl(Constants.LOGIN_URL);
    ...
    public Request getFogotPasswordRequest(String pEmailId) throws JSONException
    {
        ...
        lFPRequest.addRequestHeader(
                new BasicHeader(Constants.TH_CLIENT_VERSION, Constants.TH_CLIENT_VERSION_VALUE));
        //lLoginRequest.addRequestHeader(new BasicHeader(Constants.TH_FB_PREFIX,pFBAuthToken ));
        lFPRequest.addRequestHeader(
                new BasicHeader(Constants.CONTENT_TYPE, Constants.CONTENT_TYPE_VALUE_JSON));
        lFPRequest.setRequestType(
                Request.REQUEST_TYPE_POST_JSON);        //lLoginRequest.setRequestJSonObject(jsonLoginObject);
