...
public class HttpRequestUtil
{
    ...
    public static String doGetBasicAuthenictaion(Context context, String url, String authUser,
            String authPass)
    {
        URI uri = null;
     ...
     * @return
     */
    public static String doGetRequestNgetResponseBody(Context context, String url,
     ...
     * @return
     */
    public static String doEmailLoginPostRequestNgetResponseBody(Context context, String url,
     ...
     * @return
     */
    public static String doLinkedLoginRequestNgetResponseBody(Context context, String url,
            String pTokenSceret, String pToken)
    {
        ...
        try
        {
            ...
            String r = "{ \"linkedin_access_token\": \""
                    + pToken
    ...
    public static String doTwitterLoginRequestNgetResponseBody(Context context, String url,
            String pTokenSceret, String pToken)
    {
     ...
     * @return
     */
    public static String doPostRequestNgetResponseBody(Context context, String url,
            JSONObject jsonParams, List<Header> headerList)
    {
     ...
     * @return
     */
    public static HashMap doGetRequestNgetResponseHeader(Context context, String url,
            List<Header> headerList)
    {
     ...
     * @return
     */
    public static HashMap doPostRequestNgetResponseHeader(Context context, String url,
            JSONObject jsonParams)
    {
