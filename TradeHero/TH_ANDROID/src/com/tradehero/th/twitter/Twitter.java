...
public class Twitter
{
     ...
     *
     * Starts either an activity or dialog that a user will use to enter their credentials to
     * authorize your application with Twitter.
     *
     * @param activity The Activity to display the authorization window on.
     * @param listener The callback for Twitter authentication responses.
     */
     ...
     * @param listener The callback for Twitter authentication responses.
     */
    public boolean authorize(Activity activity, boolean forceLogin, String screenName,
     ...
     * @param screenName Prefills the username input box of the OAuth login screen with the given
     * value.
     * @param activityCode The requestCode used in Activity#onActivityResult. Can be changed if the
     * default conflicts with another Activity in your application.
     * @param listener The callback for Twitter authentication responses.
     */
    public boolean authorize(Activity activity, boolean forceLogin, String screenName,
            int activityCode, DialogListener listener)
    {
        ...
        {
            authorizeParams +=
                    (authorizeParams.length() == 0 ? "&" : "?") + "screen_name=" + screenName;
        }
    ...
    private boolean startTwitterActivity(Activity activity, String authorizeParams,
            int activityCode, DialogListener listener)
    {
    ...
    private boolean startTwitterDialog(Activity activity, String authorizeParams,
            final DialogListener listener)
    {
        TwitterDialog dialog =
                new TwitterDialog(activity, mConsumer, authorizeParams, new DialogListener()
                {
                    @Override
