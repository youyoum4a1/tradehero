        ...
        AsyncTask task = new AsyncTask()
        {
            ...
            protected void onPostExecute(String result)
            {
                ...
                try
                {
                    ...
                    //        new OAuth1FlowDialog(context, result, "twitter-oauth://complete",
                    //                "api.twitter", new OAuth1FlowDialog.FlowResultHandler()
                    //        {
                    //            public void onError(int errorCode, String description,
                    //                    String failingUrl)
                    //            {
                    //                callback.onError(new OAuth1FlowException(errorCode, description,
                    //                                        failingUrl));
                    //            }
                    //
