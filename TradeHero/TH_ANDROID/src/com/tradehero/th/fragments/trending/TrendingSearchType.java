...
{
    @TrendingSearchTypeInfo(stringResourceId = R.string.search_stock_spinner_stock, drawableResourceId = R.drawable.toggle_stocks)
    STOCKS(0),

    @TrendingSearchTypeInfo(stringResourceId = R.string.search_stock_spinner_people, drawableResourceId = R.drawable.toggle_users)
    PEOPLE(1);
