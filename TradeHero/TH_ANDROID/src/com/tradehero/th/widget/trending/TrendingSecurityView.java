...
public class TrendingSecurityView extends FrameLayout
{
    ...
    protected void init ()
    {
        ...
        {
            mImageLoader = new ImageLoader(getContext(), ImageUtils.createDefaultWhiteToTransparentProcessor(), 3, R.drawable.default_image);
        }
