...
import com.handmark.pulltorefresh.library.pulltorefresh.PullToRefreshAdapterViewBase;
 ...
 */
abstract public class PullToRefreshListViewBase<ListViewType extends ListView>
        extends PullToRefreshAdapterViewBase<ListViewType>
{
    ...
    abstract protected ListViewType createListView(Context context, AttributeSet attrs);

    @Override
    protected ListViewType createRefreshableView(Context context, AttributeSet attrs)
    {
        ListViewType lv = createListView(context, attrs);
    ...
    protected void handleStyledAttributes(TypedArray a)
    {
        ...
        mListViewExtrasEnabled =
                a.getBoolean(R.styleable.PullToRefresh_ptrListViewExtrasEnabled, true);
