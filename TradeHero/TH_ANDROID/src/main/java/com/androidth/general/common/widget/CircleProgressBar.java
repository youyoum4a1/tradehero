...
public class CircleProgressBar extends View
{
    ...
    private final static int DEFAULT_COMPLETE_PAINT_COLOR = Color.parseColor("#1376FB");
    ...
    private final static int DEFAULT_FILL_COLOR = Color.parseColor("#FFFFFF");
    ...
    private void calcuateBeforeDraw()
    {
        ...
        {
            mFillBlockRaidus = mTotalRaidus * 0.90f;
        }
    ...
    private void drawCompleteCircle(Canvas canvas)
    {
        ...
        canvas.drawArc(oval, -90, sweepAngle, true, mCompletePaint);
    }
    ...
    private void drawBgBackGround(Canvas canvas)
    {
        if (mBackGround != null)
        {
            canvas.drawBitmap(mBackGround, (mCX * 2 - mBackGround.getWidth()) / 2, (mCY * 2 - mBackGround.getHeight()) / 2, mFillPaint);
        }
    }
    ...
    public void setBitmapBg(Bitmap src)
    {
        this.mBackGround = src;
    }
}
