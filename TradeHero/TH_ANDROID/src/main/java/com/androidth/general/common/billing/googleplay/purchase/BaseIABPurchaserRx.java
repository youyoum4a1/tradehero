...
import com.androidth.general.common.billing.googleplay.exception.IABSubscriptionUnavailableException;
import com.androidth.general.common.billing.googleplay.exception.IABUnknownErrorException;
        ...
        IABPurchaseType>
{
     ...
     * method from your Activity's {@link Activity@onActivityResult} method. This method MUST be called from the UI thread of the
     * Activity.
     *
     *
     * @param activity
