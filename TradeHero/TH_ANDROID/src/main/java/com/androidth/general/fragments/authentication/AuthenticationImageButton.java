...
public class AuthenticationImageButton extends ImageView
{
    private SocialNetworkEnum type;

    //region constructors
    public AuthenticationImageButton(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(context, attrs);
    }

    public AuthenticationImageButton(Context context, AttributeSet attrs, int defStyle)
    {
