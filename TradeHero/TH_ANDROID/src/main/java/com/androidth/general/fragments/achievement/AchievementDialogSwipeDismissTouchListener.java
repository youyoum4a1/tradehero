...
/**
 * A {@link View.OnTouchListener} that makes any {@link com.androidth.general.fragments.achievement.AchievementDialogFragment} dismissable when the user
 ...
 *
 * <pre>
 * view.setOnTouchListener(new AchievementDialogSwipeDismissTouchListener(
 *         view,
...
public class AchievementDialogSwipeDismissTouchListener implements View.OnTouchListener
{
     ...
     * @param callbacks The callback to trigger when the user has indicated that she would like to dismiss this view.
     */
    public AchievementDialogSwipeDismissTouchListener(View view, Object token, DismissCallbacks callbacks)
    {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent)
    {
        ...
        switch (motionEvent.getActionMasked())
        {
            case MotionEvent.ACTION_DOWN:
            {
                ...
                //Returns true here for ViewGroup, or it won't detect any movement action
                return true;
            }
