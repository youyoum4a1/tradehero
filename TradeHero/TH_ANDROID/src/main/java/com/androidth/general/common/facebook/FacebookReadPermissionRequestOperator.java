...
public class FacebookReadPermissionRequestOperator implements Observable.OnSubscribe<Pair<Session, SessionState>>
{
    @NonNull private final Session session;
    @NonNull private final Session.NewPermissionsRequest request;

    //<editor-fold desc="Constructors">
    public FacebookReadPermissionRequestOperator(
