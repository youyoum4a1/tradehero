...
{
    /**
     * Get <i>next</i> number of {@link com.androidth.general.api.achievement.QuestBonusDTO} inclusive of <i>currentLevel</i>
     *
     ...
     * @param next number of {@link com.androidth.general.api.achievement.QuestBonusDTO} to be retrieved
     * @return {@link java.util.List} of {@link com.androidth.general.api.achievement.QuestBonusDTO}
     */
    ...
    /**
     * Get <i>numOfItems</i> - or less if the size of the list is less than <i>numOfItems</i> - {@link com.androidth.general.api.achievement.QuestBonusDTO}
     * which includes the {@link com.androidth.general.api.achievement.QuestBonusDTO} with <i>currentLevel</i>
     *
     * @param currentLevel currentLevel
     * @return {@link java.util.List} of {@link com.androidth.general.api.achievement.QuestBonusDTO}
     */
