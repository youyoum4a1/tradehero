...
public class YahooChartDTO implements ChartDTO {
    ...
    @NonNull
    public static List<YahooMovingAverageInterval> defaultMovingAverageIntervalsForWarrants() {
        ArrayList<YahooMovingAverageInterval> created = new ArrayList<>();
        created.add(YahooMovingAverageInterval.m5);
        created.add(YahooMovingAverageInterval.m10);
        created.add(YahooMovingAverageInterval.m15);
        return created;
    }
