...
{
    private static final String UPGRADE_INTENT_ACTION_NAME = "com.tradehero.th.upgrade.ALERT";
    private static final String RENEW_TOKEN_INTENT_ACTION_NAME = "com.androidth.general.auth.token.ALERT";
