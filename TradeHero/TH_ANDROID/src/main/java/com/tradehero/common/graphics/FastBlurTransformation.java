...
// android ported by shiangzhang <shiangzhang@outlook.com>
//	2013-06-05
public class FastBlurTransformation implements Transformation
{
    private int radius;
    ...
    public FastBlurTransformation(int radius)
    {
        if (radius < 1)
        {
            throw new IllegalArgumentException("Cannot accept radius<1, was " + radius);
        }
        this.radius = radius;
    }
