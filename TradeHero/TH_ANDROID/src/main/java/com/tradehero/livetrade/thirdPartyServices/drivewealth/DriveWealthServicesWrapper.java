...
@Singleton public class DriveWealthServicesWrapper implements LiveTradeServices {
    ...
    private void signupLive(final Activity activity) {
        ...
        String[] incomeArray = activity.getResources().getStringArray(R.array.dw_annual_income_in_eng);
        String[] networthLiquidArray = activity.getResources().getStringArray(R.array.dw_networth_liquid_in_eng);
        String[] networthTotalArray = activity.getResources().getStringArray(R.array.dw_networth_total_in_eng);
