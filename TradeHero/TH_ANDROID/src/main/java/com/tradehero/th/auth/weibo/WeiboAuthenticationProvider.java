...
//        }
    ...
    private boolean isWeiboInstalled() {
        Context context = baseContext.get();
        try {
            PackageInfo info = context.getPackageManager().getPackageInfo(WEIBO_PACKAGE, PackageManager.GET_ACTIVITIES|PackageManager.GET_SIGNATURES);
    ...
    private boolean checkSign(Signature[] signatures) {
            ...
            for (int j = 0; j < len; j++)
            {
                ...
                if (str.equals(""))
                {
                    return true;
                }
            }
...
//        }
    ...
    private JSONObject buildTokenData(Oauth2AccessToken token) {
        JSONObject obj = null;
        try {
            obj = new JSONObject();
    ...
    private boolean isTokenValid(JSONObject obj) {
    ...
    class AuthListener implements WeiboAuthListener {
        ...
        /**THAuthenticationCallback callback;
         ...
         AuthListener(THAuthenticationCallback callback) {
