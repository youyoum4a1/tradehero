...
public class NetworkConstants
{
    ...
    //public static final String TRADEHERO_PROD_API_ENDPOINT = "http://jackfortune.chinacloudapp.cn/TH_API/api/";

    //public static final String TRADEHERO_PROD_API_ENDPOINT = "http://192.168.20.49/api/";
