...
public class THIABPurchaser extends IABPurchaser<IABSKU, THIABProductDetails, THIABOrderId, THIABPurchaseOrder, BaseIABPurchase>
{
    ...
    @Override protected THIABProductDetails getProductDetails(IABSKU iabsku)
    {
