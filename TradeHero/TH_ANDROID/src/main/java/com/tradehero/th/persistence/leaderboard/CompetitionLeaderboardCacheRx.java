...
@Singleton public class CompetitionLeaderboardCacheRx extends BaseFetchDTOCacheRx<CompetitionLeaderboardId, CompetitionLeaderboardDTO>
{
    ...
    @Inject public CompetitionLeaderboardCacheRx(@NotNull CompetitionServiceWrapper competitionServiceWrapper)
    {
