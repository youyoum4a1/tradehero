        ...
        implements WithTutorial
{
    ...
    @Override public void onViewCreated(View view, Bundle savedInstanceState)
    {
        ...
        {
            LiveWidgetScrollListener liveWidgetScrollListener = new LiveWidgetScrollListener(fragmentElements.get(), ((TrendingMainFragment) getParentFragment()).getLiveUtil());
