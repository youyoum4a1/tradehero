...
public final class BroadcastConstants
{
    public static final class Achievement
    {
        ...
        private Achievement() { } // No instance
    }
    ...
    public static final class OnBoard
    {
        ...
        public static final BroadcastData ON_BOARDING_BROADCAST_DATA =
                ImmutableBroadcastData.create(KEY_ON_BOARD_BROADCAST, ON_BOARD_INTENT_ACTION_NAME);

        private OnBoard() { } // No instance
    }

    public static final class CompetitionEnrollment
    {
        ...
        public static final BroadcastData COMPETITION_ENROLLMENT_BROADCAST_DATA =
                ImmutableBroadcastData.create(KEY_ENROLLMENT_BROADCAST, ENROLLMENT_INTENT_ACTION_NAME);

        private CompetitionEnrollment() { } // No instance
    }

    public static final class SendLove
    {
        ...
        public static final BroadcastData SEND_LOVE_BROADCAST_DATA =
                ImmutableBroadcastData.create(KEY_SEND_LOVE_BROADCAST, SEND_LOVE_INTENT_ACTION_NAME);

        private SendLove() { } // No instance
    }

    public static final class FxOnBoard
    {
        ...
        private FxOnBoard() { } // No instance
    }

    private BroadcastConstants() { } // No instance
}
