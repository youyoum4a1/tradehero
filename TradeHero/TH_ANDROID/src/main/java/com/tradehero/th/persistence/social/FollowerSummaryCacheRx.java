...
@Singleton public class FollowerSummaryCacheRx extends BaseFetchDTOCacheRx<UserBaseKey, FollowerSummaryDTO>
{
    ...
    @Inject public FollowerSummaryCacheRx(@NotNull FollowerServiceWrapper followerServiceWrapper)
    {
