...
public class OnBoardExchangeAdapter extends DTOAdapterNew<OnBoardExchangeDTO>
{
    ...
    public OnBoardExchangeAdapter(@NonNull Context context,
    ...
    @Override public OnBoardExchangeDTO getItem(int position)
    {
        if (super.getCount() == 0)
        {
            return null;
