...
@Singleton @UserCache public class HeroCacheRx extends BaseDTOCacheRx<FollowerHeroRelationId, HeroDTO>
{
    ...
    @Inject public HeroCacheRx(@NotNull DTOCacheUtilRx dtoCacheUtil)
    {
        super(DEFAULT_MAX_VALUE_SIZE, DEFAULT_MAX_SUBJECT_SIZE, dtoCacheUtil);
    }
    //</editor-fold>

    public void onNext(@NotNull UserBaseKey followerId, @NotNull HeroDTOList values)
    {
    ...
    @Deprecated
    @NotNull HeroDTOList getValue(@NotNull FollowerHeroRelationIdList keys)
    {
