...
abstract public class AbstractBuySellFXFragment extends BasePurchaseManagerFragment
{
    ...
    public final static String BUNDLE_KEY_IS_BUY = AbstractBuySellFXFragment.class.getName() + ".isBuy";
    public final static String BUNDLE_KEY_QUANTITY_BUY = AbstractBuySellFXFragment.class.getName() + ".quantityBuy";
    public final static String BUNDLE_KEY_QUANTITY_SELL = AbstractBuySellFXFragment.class.getName() + ".quantitySell";
    public final static String BUNDLE_KEY_PROVIDER_ID_BUNDLE = AbstractBuySellFXFragment.class.getName() + ".providerId";
