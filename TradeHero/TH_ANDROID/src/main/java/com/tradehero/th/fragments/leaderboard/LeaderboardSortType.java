...
public enum LeaderboardSortType
{
    ...
    Followers(R.string.leaderboard_sort_followers, R.drawable.logo, R.drawable.sort_followers_white, R.layout.lbmu_item_followers_mode),
    Comments(R.string.leaderboard_sort_comments, R.drawable.launcher, R.drawable.sort_comments_white, R.layout.lbmu_item_comments_mode),
