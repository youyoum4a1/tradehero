...
{
    /**
     * Queue overflow You tried to send too many messages too quickly and your message queue overflowed. Try sending your message again after waiting
     * some time.
     */
    C30001(30001),

    /**
     * Account suspended Your account was suspended between the time of message send and delivery. Please contact Twilio.
     */
    C30002(30002),

    /**
     * Unreachable destination handset The destination handset you are trying to reach is switched off or otherwise unavailable.
     */
    C30003(30003),
    ...
    /**
     * Landline or unreachable carrier The destination number is unable to receive this message. Potential reasons could include trying to reach a
     * landline or, in the case of short codes, an unreachable carrier.
     */
    C30006(30006),

    /**
     * Carrier violation Your message content was flagged as going against carrier guidelines.
     */
    C30007(30007),
