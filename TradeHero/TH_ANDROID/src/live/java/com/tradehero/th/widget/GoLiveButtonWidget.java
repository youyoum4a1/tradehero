...
public class GoLiveButtonWidget extends Button
{
    ...
    public GoLiveButtonWidget(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init();
    }

    public GoLiveButtonWidget(Context context, AttributeSet attrs, int defStyleAttr)
    {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP) public GoLiveButtonWidget(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes)
    {
